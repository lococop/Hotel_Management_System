...
class Cleanup_Revise extends React.Component{
    ...
    addCustomer = () => {
        ...
        else if(this.state.revise_element === "청소상태"){
            this.state.revise_element = "clean_status";
        }
        else if(this.state.revise_element === "필요인원"){
            this.state.revise_element = "clean_members";
        }
        else if(this.state.revise_element === "청소시간"){
            this.state.revise_element = "clean_time";
        }
...
export default withStyles(styles)(Cleanup_Revise);